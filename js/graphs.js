...
//Read data from source file
    ...
    d3.csv("data/countries of the world.csv", function (error, data) {
...
//Plotting points on graph
        ...
        circles.on("mouseover", function (d) {
            ...
            //console.log(yText);
            if (yText === "GDP ($ per capita)") {
                div.html("Country:" + d.Country + "<br/>" + "GDP($): " + formatNumber(d.yText))
                ...
                div.html("Country:" + d.Country + "<br/>" + "Pop: " + d.Population)
                    .style("left", (d3.event.pageX) + "px")
                    .style("top", (d3.event.pageY - 28) + "px")

            }
            else if (yText === "Agriculture") {
                div.html("Country:" + d.Country + "<br/>" + "% Agri: " + formatNumber(d.yText * 100))
                    .style("left", (d3.event.pageX) + "px")
                    .style("top", (d3.event.pageY - 28) + "px")
